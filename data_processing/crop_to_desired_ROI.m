function [cropped_image] = crop_to_desired_ROI(I,coordinates_1,coordinates_2,outer_bound_radius1,offset)
...
cropped_image=imcrop(I,[c_x-(radius+offset) c_y-(radius+offset) radius*2+2*offset radius*2+2*offset]);
% image(X)
% hold on
% imshow(X,[])
% plot(xs1', ys1' ,'r');
